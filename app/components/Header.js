...
const NavBar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 h-[55px] w-screen p-4 z-40 flex flex-row opacity-90 dark:opacity-80 bg-white rounded-lg dark:bg-gray-900 text-slate-300  dark:text-slate-100 shadow">
      <div className="pl-1">
